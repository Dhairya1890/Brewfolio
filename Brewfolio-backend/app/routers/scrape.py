...
async def _run_scrape_job(job_id: str, platforms: PlatformInputs) -> None:
    ...
    try:
        ...
        if platforms.github and platforms.github.strip():
            tasks.append(("github", GithubScraper().scrape(platforms.github.strip())))
        if platforms.leetcode and platforms.leetcode.strip():
            tasks.append(("leetcode", LeetcodeScraper().scrape(platforms.leetcode.strip())))
        if platforms.codeforces and platforms.codeforces.strip():
            tasks.append(("codeforces", CodeforceScraper().scrape(platforms.codeforces.strip())))
        if platforms.atcoder and platforms.atcoder.strip():
            tasks.append(("atcoder", AtcoderScraper().scrape(platforms.atcoder.strip())))
        if platforms.codechef and platforms.codechef.strip():
            tasks.append(("codechef", CodechefScraper().scrape(platforms.codechef.strip())))
